...
<body>
    ...
    <main class="container my-5">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "SELECT * FROM pharmacists WHERE email = '$email'";
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO pharmacists (fullname,email,phone,date_of_birth,gender,address,location,password) VALUE (?,?,?,?,?,?,?,?)";
        ...
        <div class="text-center fw-bolder h3 text-blue">Pharmacist</div>
        ...
        <p class="text-center"><a href="../../dashboard/admin/pharmacists/landing_page.php" class="text-center">Go back</a></p>
    </main>
