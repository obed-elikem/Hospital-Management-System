    ...
    <main class="container my-5">
        ...
        if (isset($_POST["submit"])) {
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO nurses (fullname,email,phone,date_of_birth,gender,address,location,password) VALUE (?,?,?,?,?,?,?,?)";
        ...
        <div class="text-center fw-bolder h3 text-blue">Nurse</div>
        ...
        <p class="text-center"><a href="../../dashboard/admin/nurses/landing_page.php" class="text-center">Go back</a></p>
    </main>
