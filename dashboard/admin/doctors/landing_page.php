    ...
    <div class="row">
      ...
      <div class="col-md-9 col-lg-9">
        <main class="main mt-5 pt-5">
          ...
          <div class="topbar fixed-top bg-white d-flex justify-content-between mx-auto">
            ...
            <div class="search-info d-flex align-items-center">
              ...
              <div class="user d-flex justify-space-evenly align-items-center">
                <li class="list-unstyled dropdown pe-3">
                  <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="" alt="Profile" class="rounded-circle" width="40px" height="40px">
                    <span class="d-none d-md-block dropdown-toggle ps-2">Blause</span>
          ...
          <section class="container">
            <section class="container">
              ...
              $role = "doctors"; // Display only doctors
              ...
              <div class="d-flex justify-content-between">
                ...
                <p><a href="../../doctors/register.php" class="nav-link"><i class="fas fa-plus fa-md rounded-circle">Add Doctor</i></a></p>
              </div>
