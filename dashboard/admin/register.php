    ...
    <main class="container my-5">
        ...
        if (isset($_POST["submit"])) {
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO admin (fullname,email,phone,date_of_birth,gender,address,location,password) VALUE (?,?,?,?,?,?,?,?)";
        ...
        <div class="text-center fw-bolder h3 text-blue">Adminstrator</div>
