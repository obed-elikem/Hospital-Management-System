...
$laboratorist_query = "SELECT COUNT(*) as total_accountants FROM accountants";
$laboratorist_result = mysqli_query($connection, $laboratorist_query);
$laboratorist_row = mysqli_fetch_assoc($laboratorist_result);
$totalaccountants = $laboratorist_row['total_accountants'];

// Calculate the total number of invoices
$laboratorist_query = "SELECT COUNT(*) as total_invoices FROM invoices";
$laboratorist_result = mysqli_query($connection, $laboratorist_query);
$laboratorist_row = mysqli_fetch_assoc($laboratorist_result);
$totalinvoices = $laboratorist_row['total_invoices'];

// Calculate the total number of accountants
$laboratorist_query = "SELECT COUNT(*) as total_payments FROM payments";
$laboratorist_result = mysqli_query($connection, $laboratorist_query);
$laboratorist_row = mysqli_fetch_assoc($laboratorist_result);
$totalpayments = $laboratorist_row['total_payments'];

// Fetch the user's name from the admin table using the stored ID
$query = "SELECT fullname FROM accountants WHERE id = ?";
