...
<body>
    ...
    <main class="container my-5">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "SELECT * FROM accountants WHERE email = '$email'";
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO accountants (fullname,email,phone,date_of_birth,gender,address,location,password) VALUE (?,?,?,?,?,?,?,?)";
        ...
        <div class="text-center fw-bolder h3 text-blue">Accountant</div>
        ...
        <p class="text-center"><a href="../../dashboard/admin/accountants/landing_page.php" class="text-center">Go back</a></p>
    </main>
