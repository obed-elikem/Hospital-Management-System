...
$laboratorist_query = "SELECT COUNT(*) as total_doctors FROM doctors";
$laboratorist_result = mysqli_query($connection, $laboratorist_query);
$laboratorist_row = mysqli_fetch_assoc($laboratorist_result);
$totaldoctors = $laboratorist_row['total_doctors'];

// Calculate the total number of doctors
$laboratorist_query = "SELECT COUNT(*) as total_patients FROM patients";
$laboratorist_result = mysqli_query($connection, $laboratorist_query);
$laboratorist_row = mysqli_fetch_assoc($laboratorist_result);
$totalpatients = $laboratorist_row['total_patients'];

// Fetch the user's name from the admin table using the stored ID
$query = "SELECT fullname FROM doctors WHERE id = ?";
