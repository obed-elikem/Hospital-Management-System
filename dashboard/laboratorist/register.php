...
<body>
    ...
    <main class="container my-5">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "SELECT * FROM laboratorists WHERE email = '$email'";
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO laboratorists (fullname,email,phone,date_of_birth,gender,address,location,password) VALUE (?,?,?,?,?,?,?,?)";
        ...
        <div class="text-center fw-bolder h3 text-blue">Laboratorist</div>
        ...
        <p class="text-center"><a href="../../dashboard/admin/laboratorists/landing_page.php" class="text-center">Go back</a></p>
    </main>
